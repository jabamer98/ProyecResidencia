   ...
   public class clsFunciones
    {
        ...
        */
        ...
        public class CreaTicket
        {
            ...
            {
                string LineEncavesado = "Articulo       Cant   P.Unit    Valor";   //110 caracteres agrega lineas de  encabezados antes cuarenta
            ...
            public void TextoIzquierda(string par1)                          // agrega texto a la izquierda
            {
                ...
                {
                    cort = max - 110;
                    parte1 = par1.Remove(110, cort);        // si es mayor que 110 caracteres, lo corta
                }
                else { parte1 = par1; }                      // **********
            ...
            public void TextoDerecha(string par1)
            {
                ...
                max = 110 - par1.Length;                     // obtiene la cantidad de espacios para llegar a 110
                for (int i = 0; i < max; i++)
                {
            ...
            public void TextoCentro(string par1)
            {
                ...
                max = (int)(110 - parte1.Length) / 2;         // saca la cantidad de espacios libres y divide entre dos
                for (int i = 0; i < max; i++)                // **********
                {
            ...
            public void TextoExtremos(string par1, string par2)
            {
                ...
                max = 110 - (parte1.Length + parte2.Length);
                for (int i = 0; i < max; i++)                 // **********
                {
            ...
            public void AgregaTotales(string par1, double total)
            {
                ...
                {
                    cort = max - 30;
                    parte1 = par1.Remove(30, cort);          // si es mayor que 25 lo corta
                }
                else { parte1 = par1; }                      // **********
                ticket = parte1;
            ...
            public void Letra(string par1, string total)
            {
                max = par1.Length;
                if (max > 25)                                 // **********
                {
                ...
                ticket = parte1;
                parte2 = total.ToString() + " Pesos 00/100 M.N.";
                max = 110 - (parte1.Length + parte2.Length);
                for (int i = 0; i < max; i++)                // **********
                {
                    ticket += "";                           // Agrega espacios para poner el valor de moneda al final
            ...
            public void RellenarDatos(string par1, string total)
            {
                max = par1.Length;
                if (max > 110)                                 // **********
                {
                    cort = max - 110;
                    parte1 = par1.Remove(110, cort);          // si es mayor que 25 lo corta
                }
                else { parte1 = par1; }                      // **********
                ticket = parte1;
                parte2 = total.ToString() + "";
